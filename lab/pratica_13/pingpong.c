...
void pingpong_init() {
  ...
  dispatcher.processor_time = 0;
  dispatcher.execution_time = 0;
...
void task_exit(int exit_code) {
  ...
  printf("Task %d exit: execution time %d ms, processor time %d ms, %d activations\n", current_task->tid, current_task->execution_time, current_task->processor_time, current_task->activations);
